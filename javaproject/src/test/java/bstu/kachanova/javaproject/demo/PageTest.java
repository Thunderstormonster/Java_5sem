...
//позволяет нам тестировать обработку запросов Spring-MVC без запуска реального сервера.
...
public class PageTest {
    ...
    @Test
    public void loadMainPage() throws Exception { logger.info("running main page test");
        mockMvc.perform(get("/")).andDo(print()).andExpect(status().is2xxSuccessful()); }

    @Test
    public void LoadUser() throws Exception { logger.info("running get /users api");
